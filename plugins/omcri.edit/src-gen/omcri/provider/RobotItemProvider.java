...
/**
 * This is the item provider adapter for a {@link omcri.Robot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RobotItemProvider extends ResourceItemProvider {
	/**
		...
		newChildDescriptors.add
			(createChildParameter
				(OCCIPackage.Literals.ENTITY__PARTS,
				 OmcriFactory.eINSTANCE.createActuator()));

		newChildDescriptors.add
			(createChildParameter
				(OCCIPackage.Literals.ENTITY__PARTS,
				 OmcriFactory.eINSTANCE.createTouchsensor()));

		newChildDescriptors.add
			(createChildParameter
				(OCCIPackage.Literals.ENTITY__PARTS,
				 OmcriFactory.eINSTANCE.createMotionactuator()));

		newChildDescriptors.add
			(createChildParameter
				(OCCIPackage.Literals.ENTITY__PARTS,
				 OmcriFactory.eINSTANCE.createSensor()));

		newChildDescriptors.add
			(createChildParameter
				(OCCIPackage.Literals.ENTITY__PARTS,
				 OmcriFactory.eINSTANCE.createColorsensor()));

		newChildDescriptors.add
			(createChildParameter
				(OCCIPackage.Literals.ENTITY__PARTS,
				 OmcriFactory.eINSTANCE.createUltrasonicsensor()));

		newChildDescriptors.add
			(createChildParameter
				(OCCIPackage.Literals.ENTITY__PARTS,
				 OmcriFactory.eINSTANCE.createMouthactuator()));
