 ...
 * @generated
 */
public class Legomindstormnxt2Switch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Legomindstormnxt2Switch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Legomindstormnxt2Package.LEGOMINDSTORMNXT2: {
