...
/**
 * This is the item provider adapter for a {@link omcricore.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionItemProvider extends MixinBaseItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_timeOut_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_timeOut_feature", "_UI_Connection_type"),
				 OmcricorePackage.Literals.CONNECTION__TIME_OUT,
				 true,
				 false,
				 false,
